<div class="btn-group bg-secondary" role="group">
    @if (isset($proyecto->empresa))
        <a class="btn btn-secondary" href="{{ route('proyecto.asociados', $proyecto->id) }}" title="Asociados">
            Asociados
        </a>

        <a class="btn btn-secondary" href="{{ route('proyecto.editplanillas', $proyecto->id) }}"
    ...
    @else
        <a class="btn btn-secondary" href="#" title="Asociados">
            Asociados
        </a>
    ...
    @if (Auth::user()->hasRole(['superadmin', 'admin']) and $proyecto->evaluacion)
