    ...
    <div class="card-body">
        ...
        <div class="form-group mt-3 mb-4 row">
            <div class="col-4">
                ...
                <img src="/economicoemprendedor/images/upload/noticias/{{ $noticia->imagen }}" class="img-thumbnail" width="150" height="150">
                @else
                <img src="{{ asset('/public/images/frontend/imagen-no-disponible.png') }}" class="img-thumbnail" width="150" height="150">
                @endif
            </div>
            <div class="col-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-4">
                <label class="checkbox-inline">
                    Publicada <br>
                    <input type="checkbox" @if (isset($noticia) && $noticia->active) checked="" @endif name="active" id="active" value='1'>
                </label>
            </div>
        </div>
        ...
        <div class="form-group mb-3">
            ...
            {!! Form::textarea('cuerpo', null, ['class' => 'form-control', 'rows'=>5]) !!}
        </div>
