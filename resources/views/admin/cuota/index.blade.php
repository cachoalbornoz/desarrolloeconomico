    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <div class="row mb-5">
                    <div class="col-xs-12 col-sm-6 col-xs-6">
                        Monto crédito <strong> {{number_format($expediente->monto,2,',','.')}} </strong>
                        <input type="hidden" name="montop" id="montop" value="{{$expediente->monto}}" />
                    </div>
                    <div class="col-xs-12 col-md-6 col-lg-6">
                        Fecha otorgamiento <strong>
                            <input type="date" readonly="true" name="fechao" id="fechao" value="{{$expediente->fecha_otorgamiento}}" class="text-center">
                        </strong>
                    </div>
                </div>
            ...
            <div class="card-body">
                ...
                <div class="row text-center mt-3">
                    ...
                    <div class="col-xs-12 col-sm-2 col-xs-2">
                        <input type="date" name="fechaVcto" id="fechaVcto" class="form-control text-center" value={{date(now())}}>
                    </div>
                    <div class="col-xs-12 col-sm-2 col-xs-2">
...
<script>
    ...
    const registrar = () => {
        ...
        if(monto > 0 && fechaVcto != 0){
            ...
            $.ajax({
                ...
                type 	: 'POST',
                dataType: 'json',
                data 	: {cuotas, expediente, nroCuota, monto, fechaVcto, manual},
            ...
            toastr.options = { "progressBar": true, "showDuration": "1500", "timeOut": "1500" };
    ...
    const generar_18 = () => {
        ...
        const fecha     = document.getElementById('fechaVcto').value;
        
        $.ajax({
            url 	: "{{ route('cuota.store') }}",
            type 	: 'POST',
            dataType: 'json',
            data 	: {cuotas, expediente, monto, fecha},
            success: function(response){
