...
<div class="row mt-5 mb-5">
    <h2 class="favenir">Noticias recientes </h2>
</div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="/economicoemprendedor/images/upload/noticias/{{ $imagen0 }}" alt="1 noticia">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="/economicoemprendedor/images/upload/noticias/{{ $imagen1 }}" alt="2 notica">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>{{ $titulo1 }}</h5>
                        <p>{{ $subtitulo1 }}</p>
                    </div>
