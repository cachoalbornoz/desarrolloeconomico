    ...
    <div class="container">
        ...
        <div class="row pb-3">
            <div class="col-xs-5 col-md-5 col-lg-5 text-center">
                <img class=" img-fluid" src="{{ asset('images/frontend/cabecera.png') }}"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <a class="dropdown-item" href={{ route('pafinanciera') }}>
                                ASISTENCIA FINANCIERA PARA EL SOSTENIMIENTO ECONOMICO
                            </a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true"
                        ...
                        <small>
                            {{ Auth::user()->nombre }} {{ Auth::user()->apellido }} (<i
                                class="fa fa-circle text-success"></i> {{ Auth::user()->tieneRol() }} )
                        </small>
                    </a>
                    <ul class="dropdown-menu">
